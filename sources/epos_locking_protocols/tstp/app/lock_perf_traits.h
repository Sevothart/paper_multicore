...
template<> struct Traits<Build>
{
    ...
    enum {IA32, ARMv7};
    static const unsigned int ARCHITECTURE = ARMv7; //ARMv7

    enum {PC, Cortex_M, Cortex_A};
    static const unsigned int MACHINE = Cortex_M; //Cortex_M

    enum {Legacy_PC, eMote3, LM3S811};
    static const unsigned int MODEL = eMote3; //eMote3
...
template<> struct Traits<System>: public Traits<void>
{
    ...
    static const unsigned int STACK_SIZE = Traits<Machine>::STACK_SIZE;
    static const unsigned int HEAP_SIZE = (Traits<Application>::MAX_THREADS + 2) * Traits<Application>::STACK_SIZE;
};
...
template<> struct Traits<Thread>: public Traits<void>
{
    ...
    static const bool srp_enabled = (!smp) && false;
};
...
template<> struct Traits<Tracer>: public Traits<void>
{
    ...
    static const bool store_enabled = false;
